...
{  
    ...
    TicTacToeGame() 
    {
        ...
        textfield.setForeground(new Color(255, 77, 77));//red colour 
        ...
        for (int i = 0; i < 9; i++) 
        {
            ...
            bton[i].setBackground(new Color(220, 206, 163));
        }
    ...
    public void startGame() 
    {
        try 
        {
            textfield.setText("Let's Begin The Game...");
            Thread.sleep(2000);
        } 
    ...
    public void xWins(int x1, int x2, int x3) 
    {
        ...
        textfield.setText("Congrulations Player X wins");
        gameOver("Congrulations Player X Wins");
    }
    ...
    public void oWins(int x1, int x2, int x3) 
    {
        ...
        textfield.setText("Congrulations Player O Wins");
        gameOver("Congrulations Player O Wins");
    }
